...
private:
    void PrintHeader(const trace::ICycle* pCycle) const
    {
        if (m_Cycle == 0)
        {
            return;
    ...
    void PrintFpReg(const trace::ICycle* pCycle) const
    {
    ...
    void PrintIoState(const trace::ICycle* pCycle) const
    {
        if (!pCycle->IsIoExist())
        {
            return;
    ...
    void PrintMemoryEvent(const trace::ICycle* pCycle) const
    {
    ...
    void PrintTrapEvent(const trace::ICycle* pCycle) const
    {
